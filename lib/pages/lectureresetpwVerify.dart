import 'package:appointmentms/pages/ResetPassword.dart';
...
class LecturerpasswordResetVerify extends StatefulWidget {
  const LecturerpasswordResetVerify({Key? key}) : super(key: key);

  @override
  State<LecturerpasswordResetVerify> createState() => _LecturerSignUpState3();
}

class _LecturerSignUpState3 extends State<LecturerpasswordResetVerify> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      context,
      MaterialPageRoute(
        builder: (context) => LecturerResetPassword(), // Replace with your actual destination
      ),
    );
            },),
