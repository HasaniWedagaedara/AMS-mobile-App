...
import 'package:appointmentms/pages/StudentResetPassword.dart';
...
class StudentpasswordResetVerify extends StatefulWidget {
  const StudentpasswordResetVerify({Key? key}) : super(key: key);

  @override
  State<StudentpasswordResetVerify> createState() => _StudentSignUpState3();
}

class _StudentSignUpState3 extends State<StudentpasswordResetVerify> {
  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      ...
      context,
      MaterialPageRoute(
        builder: (context) => StudentResetPassword(), // Replace with your actual destination
      ),
    );
            },),
